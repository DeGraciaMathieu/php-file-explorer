...
final class FileFinderTest extends TestCase
{
    ...
    public function it_can_get_the_php_files_in_a_filter(): void
    {
        ...
        self::assertCount(3, \iterator_to_array($fileFinder->getPhpFiles([__DIR__ . '/Assets']), false));
    }
    ...
    public function it_can_get_the_php_files_in_multiple_directories(): void
    {
        ...
        self::assertCount(
            7,
            \iterator_to_array($fileFinder->getPhpFiles([__DIR__ . '/Assets', __DIR__ . '/Assets2']), false)
        );
    }
    ...
    public function it_can_get_the_php_files_by_name(): void
    {
        ...
        self::assertCount(
            2,
            \iterator_to_array(
                $fileFinder->getPhpFiles([__DIR__ . '/Assets/Bar.php', __DIR__ . '/Assets/Foo.php']),
                false
            )
        );
    }
    ...
    public function it_does_not_throw_with_non_existing_path(): void
    {
        ...
        self::assertCount(0, \iterator_to_array($fileFinder->getPhpFiles([__DIR__ . '/NotExisting.php']), false));
    }
